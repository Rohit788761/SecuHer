...
public final class ActivityLoginPageBinding implements ViewBinding {
  ...
  private ActivityLoginPageBinding(@NonNull LinearLayout rootView, @NonNull Button btnLogin,
      @NonNull EditText etEmail, @NonNull EditText etPassword, @NonNull TextView loginText,
      @NonNull TextView tvCreateAccount, @NonNull TextView tvForgotPass) {
  ...
  public static ActivityLoginPageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginPageBinding((LinearLayout) rootView, btnLogin, etEmail, etPassword,
          loginText, tvCreateAccount, tvForgotPass);
    }
