...
public final class ActivityWebViewBinding implements ViewBinding {
  ...
  private ActivityWebViewBinding(@NonNull LinearLayout rootView, @NonNull WebView youtubeWebView) {
  ...
  public static ActivityWebViewBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.youtubeWebView;
      WebView youtubeWebView = ViewBindings.findChildViewById(rootView, id);
      if (youtubeWebView == null) {
        break missingId;
      }

      return new ActivityWebViewBinding((LinearLayout) rootView, youtubeWebView);
    }
